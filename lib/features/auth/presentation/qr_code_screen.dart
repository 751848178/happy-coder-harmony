...
part 'qr_code_screen_logic.dart';
part 'qr_code_screen_root_view.dart';
part 'qr_code_screen_cards.dart';
part 'qr_code_screen_qr_card.dart';
part 'qr_code_screen_manual_view.dart';
