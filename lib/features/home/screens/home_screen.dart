...
part 'home_screen_logic.dart';
part 'home_screen_refresh.dart';
part 'home_screen_machine_filters.dart';
part 'home_screen_content.dart';
part 'home_screen_header.dart';
part 'home_screen_header_actions.dart';
part 'home_screen_tab_bar.dart';
part 'home_screen_drawer.dart';
part 'home_screen_drawer_tile.dart';
