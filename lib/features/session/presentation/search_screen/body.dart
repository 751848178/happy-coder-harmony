  ...
  return Scaffold(
    ...
    body: Column(
      children: [
        ...
        Expanded(child: _buildSessionSearchResults(state, sessions, isLoading)),
      ],
    ),
  );
}
...
Widget _buildSessionSearchResults(
  ...
  return ListView.builder(
    ...
    itemBuilder: (context, index) =>
        _buildSessionSearchCard(state, sessions[index]),
  );
}
...
Widget _buildSessionSearchCard(
  _SessionSearchScreenState state,
  Session session,
) {
  return Card(
