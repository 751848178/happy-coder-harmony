...
extension _SessionScreenMessageActions on _SessionScreenState {
  ...
  Future<void> _showMessageActionSheet({
    ...
    final choice = await showBottomPopupSheet<SessionMessageActionChoice>(
      context: context,
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () => Navigator.pop(
                    context,
                    SessionMessageActionChoice.forward,
                  ),
                ),
                ListTile(
                  contentPadding: EdgeInsets.zero,
                  ...
                  onTap: () => Navigator.pop(
                    context,
                    SessionMessageActionChoice.saveTemplate,
                  ),
                ),
                ListTile(
                  contentPadding: EdgeInsets.zero,
                  ...
                  onTap: () => Navigator.pop(
                    context,
                    SessionMessageActionChoice.insertIntoComposer,
                  ),
                ),
              ],
            ),
