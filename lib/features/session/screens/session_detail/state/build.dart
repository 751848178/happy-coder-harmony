              ...
              ValueListenableBuilder<bool>(
                ...
                builder: (_, collapsed, __) {
                  ...
                  return _buildSessionOverview(
                      session, bodyState.sessionStats!);
                },
              ),
              Expanded(
                child: Stack(
                                ...
                                builder: (_, viewportReady, __) {
                                  return ValueListenableBuilder<bool>(
                                    ...
                                    builder: (_, suppressFlicker, ___) {
                                      ...
                                      return _buildMessageListStage(
                                        list: list,
                                        shouldRevealList: shouldRevealList,
                    ...
                    if (bodyState.messages.isNotEmpty)
                      ListenableBuilder(
                        listenable: Listenable.merge([
                          _canScrollToTopN,
                          _canScrollToBottomN,
                          _isLoadingOlderMessagesN,
                          _isLoadingNewerMessagesN,
                          _isHydratingArchiveHistoryN,
                          _scrollActionsCollapsedN,
                          _scrollActionDragDxN,
                          _scrollActionVerticalOffsetN,
                        ]),
                        builder: (context, __) => _buildScrollActionsOverlay(
                          viewportHeight:
